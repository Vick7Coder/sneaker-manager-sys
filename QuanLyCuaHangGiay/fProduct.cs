    ...
    public partial class fProduct : Form
    {
        ...
        public void LoadProduct()
        {
            ...
            foreach(ViewSanPham item in listSanPham)
            {
                ...
                {
                    case "Giày Jordan":
                        btn.Image = Image.FromFile(@"D:\teaching\HK1(2022_2023)\DoAnCNTT\QuanLyCuaHangGiay\images\giaythethao2.jpg");
                        break;
                    case "Giày Adidas":
                        btn.Image = Image.FromFile(@"D:\teaching\HK1(2022_2023)\DoAnCNTT\QuanLyCuaHangGiay\images\giayadidas.jpg");
                        break;
                    case "Giày Vans":
                        btn.Image = Image.FromFile(@"D:\teaching\HK1(2022_2023)\DoAnCNTT\QuanLyCuaHangGiay\images\giayvans.jpg");
                        break;
                    case "Giày Converse":
                        btn.Image = Image.FromFile(@"D:\teaching\HK1(2022_2023)\DoAnCNTT\QuanLyCuaHangGiay\images\giayconverse.jpg");
                        break;
                    default:
